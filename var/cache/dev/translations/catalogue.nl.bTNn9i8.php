...
$catalogue = new MessageCatalogue('nl', array (
  ...
  'messages' => 
  array (
    'file.add.success' => 'is succesvol geuploaded',
    'file.renamed.success' => 'Bestand is succesvol hernoemd naar een ander bestand',
    'file.renamed.danger' => 'Bestand bestaat al of u bent niet bevoegd om dit bestand een andere naam te geven.',
    'file.renamed.unauthorized' => 'De bestanden bestaan niet meer of u bent niet bevoegd om deze pagina te openen.',
    'file.renamed.nochanged' => 'Geen wijziging gedetecteerd',
    'file.deleted.success' => 'De bestanden zijn met succes verwijderd',
    'file.deleted.danger' => 'De bestanden bestaan niet meer of u bent niet bevoegd om deze pagina te openen.',
    'file.deleted.unauthorized' => 'De bestanden bestaan niet meer of u bent niet bevoegd om deze pagina te openen.',
    'folder.add.danger' => 'Er is een fout opgetreden tijdens het aanmaken van de directory: %message%',
    'folder.add.success' => 'Map is met succes aangemaakt',
    'folder.deleted.success' => 'Map is met succes verwijderd.',
    'folder.deleted.unauthorized' => 'Map bestaat niet meer of u bent niet bevoegd om deze pagina te openen.',
    'button.cancel' => 'ANULEREN',
    'button.refresh' => 'Verfrissen',
    'button.parent' => 'Parent',
    'button.save' => 'OPSLAAN',
    'button.add.files' => 'Voeg bestanden toe...',
    'button.add.folder' => 'Nieuwe map...',
    'button.delete.current' => 'Verwijder huidige map',
    'button.delete.selected' => 'Geselecteerde bestanden verwijderen',
    'button.delete.action' => 'VERWIJDER',
    'button.rename.action' => 'HERNOEMEN',
    'button.tree' => 'Boom',
    'title.add.folder' => 'Nieuwe map',
    'title.rename.file' => 'Hernoemen',
    'title.delete' => 'Verwijderen',
    'title.download' => 'Downloaden',
    'title.preview.file' => 'Openen',
    'input.default' => 'Naamloze map',
    'table.name' => 'Naam',
    'table.date' => 'Datum',
    'table.size' => 'Grootte',
    'table.dimension' => 'Dimensie',
    'table.actions' => 'Acties',
    'confirm.delete' => 'Weet u zeker dat u wilt verwijderen?',
    'size.mb' => 'MB',
    'size.kb' => 'kB',
    'select-all' => 'Selecter alle',
    'upload.exception_move_uploaded_file' => 'Toestemming geweigerd',
