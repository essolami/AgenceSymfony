...
$catalogue = new MessageCatalogue('ru', array (
  ...
  'messages' => 
  array (
    'file.add.success' => 'успешно загружен',
    'file.renamed.success' => 'Файл успешно переименован',
    'file.renamed.danger' => 'Файл уже существует или у вас недостаточно прав чтобы его переименовать',
    'file.renamed.unauthorized' => 'Файлы больше не существуют или у вас недостаточно прав для доступа к этой странице',
    'file.renamed.nochanged' => 'Изменений не найдено',
    'file.deleted.success' => 'Файлы успешно удалены',
    'file.deleted.danger' => 'Файлы больше не существуют или у вас недостаточно прав для доступа к этой странице',
    'file.deleted.unauthorized' => 'Файлы больше не существуют или у вас недостаточно прав для доступа к этой странице',
    'folder.add.danger' => 'Ошибка при создании директории: %message%',
    'folder.add.success' => 'Папка успешно создана',
    'folder.deleted.success' => 'Папка успешно удалена',
    'folder.deleted.unauthorized' => 'Папка больше не существует или у вас недостаточно прав для доступа к этой странице',
    'button.cancel' => 'ОТМЕНА',
    'button.refresh' => 'Обновить',
    'button.parent' => 'К родительской директории',
    'button.save' => 'СОХРАНИТЬ',
    'button.add.files' => 'Добавить файлы...',
    'button.add.folder' => 'Новая папка...',
    'button.delete.current' => 'Удалить текущую папку',
    'button.delete.selected' => 'Удалить выбранные файлы',
    'button.delete.action' => 'УДАЛИТЬ',
    'button.rename.action' => 'ПЕРЕИМЕНОВАТЬ',
    'button.tree' => 'Дерево',
    'title.add.folder' => 'Новая папка',
    'title.rename.file' => 'Переименовать',
    'title.delete' => 'Удалить',
    'title.download' => 'Скачать',
    'title.preview.file' => 'открыть',
    'input.default' => 'Новая папка',
    'table.name' => 'Название',
    'table.date' => 'Дата',
    'table.size' => 'Размер',
    'table.dimension' => 'Параметры',
    'table.actions' => 'Действия',
    'confirm.delete' => 'Вы уверены что хотите удалить?',
    'size.mb' => 'MB',
    'size.kb' => 'kB',
    'select-all' => 'Выбрать все',
    'upload.exception_move_uploaded_file' => 'Доступ запрещен',
