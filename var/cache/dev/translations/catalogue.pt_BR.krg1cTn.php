...
$catalogue = new MessageCatalogue('pt_BR', array (
  ...
  'messages' => 
  array (
    'file.add.success' => 'enviado com sucesso',
    'file.renamed.success' => 'O arquivo foi renomeado com sucesso',
    'file.renamed.danger' => 'Arquivo já existe ou você não está autorizado a renomear este arquivo',
    'file.renamed.unauthorized' => 'Os arquivos não existem mais ou você não tem autorização para acessar esta página',
    'file.renamed.nochanged' => 'Nenhuma alteração detectada',
    'file.deleted.success' => 'Os arquivos foram apagados com sucesso',
    'file.deleted.danger' => 'Os arquivos não existem mais ou você não tem autorização para acessar esta página',
    'file.deleted.unauthorized' => 'Os arquivos não existem mais ou você não tem autorização para acessar esta página',
    'folder.add.danger' => 'Ocorreu um erro ao criar o diretório: %message%',
    'folder.add.success' => 'Pasta criada com sucesso',
    'folder.deleted.success' => 'A pasta excluída com sucesso',
    'folder.deleted.unauthorized' => 'A pasta não existe mais ou você não tem autorização para acessar esta página',
    'button.cancel' => 'CANCELAR',
    'button.refresh' => 'Atualizar',
    'button.parent' => 'Subir',
    'button.save' => 'SALVAR',
    'button.add.files' => 'Adicionar arquivos...',
    'button.add.folder' => 'Nova pasta...',
    'button.delete.current' => 'Excluir pasta atual',
    'button.delete.selected' => 'Excluir arquivos selecionados',
    'button.delete.action' => 'EXCLUIR',
    'button.rename.action' => 'RENOMEAR',
    'button.tree' => 'Pastas',
    'title.add.folder' => 'Nova pasta',
    'title.rename.file' => 'Renomear',
    'title.delete' => 'Excluir',
    'title.download' => 'Download',
    'title.preview.file' => 'Abrir',
    'input.default' => 'Nova pasta',
    'table.name' => 'Nome',
    'table.date' => 'Data',
    'table.size' => 'Tamanho',
    'table.dimension' => 'Dimensão',
    'table.actions' => 'Ações',
    'confirm.delete' => 'Tem certeza de que deseja excluir?',
    'size.mb' => 'MB',
    'size.kb' => 'kB',
    'select-all' => 'Selecionar tudo',
    'upload.exception_move_uploaded_file' => 'Permissão negada',
