...
$catalogue = new MessageCatalogue('ca', array (
  ...
  'messages' => 
  array (
    'file.add.success' => 'S\'ha carregat correctament',
    'file.renamed.success' => 'L\'arxiu ha canviat de nom correctament',
    'file.renamed.danger' => 'L\'arxiu ja existeix o no està autoritzat per canviar el nom d\'aquest arxiu',
    'file.renamed.unauthorized' => 'Els arxius ja no existeixen o no està autoritzat per accedir a aquesta pàgina',
    'file.renamed.nochanged' => 'No s\'ha detectat cap canvi',
    'file.deleted.success' => 'Els arxius s\'han eliminat correctament',
    'file.deleted.danger' => 'Els arxius ja no existeixen o no està autoritzat per accedir a aquesta pàgina',
    'file.deleted.unauthorized' => 'Els arxius ja no existeixen o no està autoritzat per accedir a aquesta pàgina',
    'folder.add.danger' => 'S\'ha produït un error al crear el directori: %message%',
    'folder.add.success' => 'La carpeta s\'ha creat correctament',
    'folder.deleted.success' => 'La carpeta s\'ha eliminat correctament',
    'folder.deleted.unauthorized' => 'La carpeta ja no existeix o no està autoritzat per accedir a aquesta pàgina',
    'button.cancel' => 'CANCEL·LAR',
    'button.refresh' => 'Actualitzar',
    'button.parent' => 'Pare',
    'button.save' => 'GUARDAR',
    'button.add.files' => 'Afegir arxius...',
    'button.add.folder' => 'Nova carpeta...',
    'button.delete.current' => 'Eliminar la carpeta actual',
    'button.delete.selected' => 'Eliminar arxius seleccionats',
    'button.delete.action' => 'ESBORRAR',
    'button.rename.action' => 'REANOMENAR',
    'button.tree' => 'Arbre',
    'title.add.folder' => 'Nova carpeta',
    'title.rename.file' => 'Reannomenar',
    'title.delete' => 'Eliminar',
    'title.download' => 'Descarregar',
    'title.preview.file' => 'Obrir',
    'input.default' => 'Carpeta sense títol',
    'table.name' => 'Nom',
    'table.date' => 'Data',
    'table.size' => 'Mida',
    'table.dimension' => 'Dimensió',
    'table.actions' => 'Accions',
    'confirm.delete' => 'Esteu segur que voleu suprimir?',
    'size.mb' => 'MB',
    'size.kb' => 'kB',
    'select-all' => 'Selecciona-ho tot',
    'upload.exception_move_uploaded_file' => 'Permís denegat',
