...
$catalogue = new MessageCatalogue('de', array (
  ...
  'messages' => 
  array (
    'file.add.success' => 'wurde erfolgreich hochgeladen',
    'file.renamed.success' => 'Die Datei wurde erfolgreich umbenannt',
    'file.renamed.danger' => 'Die Datei existiert bereits oder Sie haben keine Rechte sie umzubenennen',
    'file.renamed.unauthorized' => 'Die Datei existiert nicht mehr oder Sie haben keine Zugriffsrechte auf diese Seite',
    'file.renamed.nochanged' => 'Kein Änderung festgestellt',
    'file.deleted.success' => 'Die Dateien wurden erfolgreich gelöscht',
    'file.deleted.danger' => 'Die Datei existiert nicht mehr oder Sie haben keine Zugriffsrechte auf diese Seite',
    'file.deleted.unauthorized' => 'Die Datei existiert nicht mehr oder Sie haben keine Zugriffsrechte auf diese Seite',
    'folder.add.danger' => 'Beim Erstellen des Verzeichnisses ist ein Fehler aufgetreten : %message%',
    'folder.add.success' => 'Das Verzeichnis wurde erfolgreich erstellt',
    'folder.deleted.success' => 'Das Verzeichnis wurde erfolgreich gelöscht',
    'folder.deleted.unauthorized' => 'Die Datei existiert nicht mehr oder Sie haben keine Zugriffsrechte auf diese Seite',
    'button.cancel' => 'ABBRECHEN',
    'button.refresh' => 'Neu laden',
    'button.parent' => 'Nach oben',
    'button.save' => 'SPEICHERN',
    'button.add.files' => 'Datei hinzufügen ...',
    'button.add.folder' => 'Verzeichnis erstellen ...',
    'button.delete.current' => 'Aktuelles Verzeichnis löschen',
    'button.delete.selected' => 'Ausgewählte Datei löschen',
    'button.delete.action' => 'LÖSCHEN',
    'button.rename.action' => 'UMBENENNEN',
    'button.tree' => 'Baumstruktur',
    'title.add.folder' => 'Neues Verzeichnis',
    'title.rename.file' => 'Umbenennen',
    'title.delete' => 'Löschen',
    'title.download' => 'Herunterladen',
    'title.preview.file' => 'Öffnen',
    'input.default' => 'Unbetiteltes Verzeichnis',
    'table.name' => 'Name',
    'table.date' => 'Datum',
    'table.size' => 'Größe',
    'table.dimension' => 'Auflösung',
    'table.actions' => 'Aktionen',
    'confirm.delete' => 'Möchten Sie dies wirklich löschen?',
    'size.mb' => 'Mb',
    'size.kb' => 'kb',
    'select-all' => 'Alles auswählen',
    'upload.exception_move_uploaded_file' => 'Zugriff verweigert',
    'search.placeholder' => 'Suche',
    'The uploaded file exceeds the upload_max_filesize directive in php.ini' => 'Die Dateigrösse überschreitet die maximal erlaubte Größe (upload_max_filesize in php.ini)',
    'The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form' => 'Die Dateigrösse überschreitet die maximal erlaubte Größe (MAX_FILE_SIZE im HTML-Formular)',
    'The uploaded file was only partially uploaded' => 'Datei wurde nur teilweise hochgeladen',
    'No file was uploaded' => 'Es wurde keine Datei hochgeladen',
    'Missing a temporary folder' => 'Es fehlt das temporäre Verzeichnis',
    'Failed to write file to disk' => 'Datei kann nicht gespeichert werden',
    'A PHP extension stopped the file upload' => 'Eine PHP-Erweiterung blockiert das Hochladen',
    'The uploaded file exceeds the post_max_size directive in php.ini' => 'Die Dateigrösse überschreitet die maximal erlaubte Größe (post_max_size in php.ini)',
    ...
    'Maximum number of files exceeded' => 'Die maximale Anzahl Dateien wurde erreicht',
    'Image exceeds maximum width' => 'Das Bild ist zu breit',
    'Image requires a minimum width' => 'Das Bild ist zu schmal',
    'Image exceeds maximum height' => 'Das Bild ist zu hoch',
    'Image requires a minimum height' => 'Das Bild ist zu niedrig',
    'File upload aborted' => 'Der Upload wurde abgebrochen',
    'Failed to resize image' => 'Beim Skalieren des Bildes ist ein Fehler aufgetreten',
  ),
));
