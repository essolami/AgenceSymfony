...
class __TwigTemplate_652d55bad01ee8b36bf52e5cfe0d1b2aa8db03f09869a907092cb4e256318aa5 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table table-striped mt-4\" style=\"border:1px solid #0000004f\">
        <tbody>
            <tr>
                <th>Id</th>
                <td>";
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>
                    ";
        // line 26
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 26, $this->source); })()), "role", [], "any", false, false, false, 26), ""))) {
            // line 27
            echo "                       <span style=\"background-color: red;color: #fff;padding: 5px;border-radius: 8px;\"> No Role Yet  </span>
                    ";
        } else {
            // line 29
            echo "                        ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 29, $this->source); })()), "role", [], "any", false, false, false, 29), "html", null, true);
            echo "
                    ";
        }
        // line 31
...
";
    ...
    {
        return array (  143 => 38,  138 => 36,  131 => 31,  125 => 29,  121 => 27,  119 => 26,  111 => 21,  104 => 17,  97 => 13,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"container mt-4\">
    ...
    <table class=\"table table-striped mt-4\" style=\"border:1px solid #0000004f\">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {% if user.role == '' %}
                       <span style=\"background-color: red;color: #fff;padding: 5px;border-radius: 8px;\"> No Role Yet  </span>
                    {% else %}
                        {{user.role}}
                    {% endif %}
                </td>
    ...
    <a href=\"{{ path('user_index') }}\" class=\"btn btn-warning\">back to list</a>

    <a href=\"{{ path('user_edit', {'id': user.id}) }}\" class=\"btn btn-info\">edit</a>
</div>

{% endblock %}
", "admin/user/show.html.twig", "C:\\Users\\Hamza\\Desktop\\Symfony\\agence\\templates\\admin\\user\\show.html.twig");
    }
}
